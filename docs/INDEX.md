...
* **[`HTML_PUBLICATION_STANDARD.md`](policies/HTML_PUBLICATION_STANDARD.md):** Perfil histórico dos artigos HTML preservados; o site foi descontinuado.
...
* **[`PAGES_CUTOVER_READINESS.md`](policies/PAGES_CUTOVER_READINESS.md):** Registro de descontinuação do site e da projeção GitHub Pages.
