...
## Manual quality criteria applied

- distinct research question ⇒ distinct study unless a successor demonstrably preserves full material value;
- scientific refresh may remain as exact bridge checkpoint without becoming preferred current synthesis;
- problem-specific technical proposal survives; generic migration boilerplate does not;
- experiments preserve negative/invalidated branches and stopping rules;
...
**SEMANTIC PRESERVATION:** PASS as candidate library structure.  
