# Runtime, Reliability & Sandbox — Research Frontier
...
| `NORMALIZED` | `INVESTIGATE` | [rp-9784d1bff6 — logical effect identity details](../pointers/rp-9784d1bff6-logical-effect-identity-details.md) | reliability-effects-durable-runtime |
| `TRIAGED` | `INVESTIGATE` | [rp-d2d246077c — Operational effect accounting](../pointers/rp-d2d246077c-operational-effect-accounting.md) | reliability-effects-durable-runtime |
| `TRIAGED` | `WATCH` | [rp-b019955343 — Partial observability and active sensing](../pointers/rp-b019955343-partial-observability-and-active-sensing.md) | reliability-effects-durable-runtime |
| `NORMALIZED` | `WATCH` | [rp-96777fdc13 — trusted invocation seam](../pointers/rp-96777fdc13-trusted-invocation-seam.md) | reliability-effects-durable-runtime |
| `NORMALIZED` | `WATCH` | [rp-be30bb9998 — Typed Canonical Lineage with typestate and effect systems](../pointers/rp-be30bb9998-typed-canonical-lineage-with-typestate-and-effect-systems.md) | reliability-effects-durable-runtime |
| `NORMALIZED` | `WATCH` | [rp-1685086184 — Windows deep-path hardening](../pointers/rp-1685086184-windows-deep-path-hardening.md) | reliability-effects-durable-runtime |
