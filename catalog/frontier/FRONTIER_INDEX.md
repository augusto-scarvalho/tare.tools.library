...
- [Assurance, Audit & Evaluator Metrology](clusters/assurance-audit-metrology.md) — 15
...
- [Reliability, Effects & Durable Runtime](clusters/reliability-effects-durable-runtime.md) — 13
- [Research Knowledge Substrate](clusters/research-knowledge-substrate.md) — 39
...
- [Agent OS Foundations](by-lineage/agent-os-foundations.md)
- [Workflow & Procedural Systems](by-lineage/workflow-procedural.md)
- [Context, Memory & Playbooks](by-lineage/context-memory-playbooks.md)
- [Assurance, Governance & Quality](by-lineage/assurance-governance-quality.md)
- [Runtime, Reliability & Sandbox](by-lineage/runtime-reliability-sandbox.md)
- [Routing, Economics & Observability](by-lineage/routing-economics-observability.md)
- [Interoperability & Protocols](by-lineage/interoperability-protocols.md)
- [Experience, TUI & UX](by-lineage/experience-ux.md)
- [Research Methodology & Evidence](by-lineage/research-methodology-evidence.md)

## All pointers

| Status | Radar | Pointer | Cluster | Origin count |
|---|---|---|---|---:|
| `TRIAGED` | `INVESTIGATE` | [rp-6a3a4ebbb2 — active curation / Value of Information](pointers/rp-6a3a4ebbb2-active-curation-value-of-information.md) | research-knowledge-substrate | 2 |
| `NORMALIZED` | `WATCH` | [rp-96f51efac1 — Adaptive Retention and Survival Value](pointers/rp-96f51efac1-adaptive-retention-and-survival-value.md) | research-knowledge-substrate | 1 |
...
| `NORMALIZED` | `WATCH` | [rp-4e3fb6ae13 — Archival Science & Long-Term Executability](pointers/rp-4e3fb6ae13-archival-science-long-term-executability.md) | research-knowledge-substrate | 1 |
| `NORMALIZED` | `WATCH` | [rp-6cdf3cef39 — Artifact-Anchored Verification Memory & Upstream Drift](pointers/rp-6cdf3cef39-artifact-anchored-verification-memory-upstream-drift.md) | research-knowledge-substrate | 1 |
...
| `NORMALIZED` | `WATCH` | [rp-c288c9262b — Bitemporal Artifact/Evidence Semantics](pointers/rp-c288c9262b-bitemporal-artifact-evidence-semantics.md) | assurance-audit-metrology | 1 |
...
| `TRIAGED` | `INVESTIGATE` | [rp-a24cdfc68a — Causal routing attribution and OPE](pointers/rp-a24cdfc68a-causal-routing-attribution-and-ope.md) | routing-reputation-economics | 3 |
...
| `NORMALIZED` | `WATCH` | [rp-f24a4b53da — constitutional/root change process](pointers/rp-f24a4b53da-constitutional-root-change-process.md) | assurance-audit-metrology | 1 |
| `NORMALIZED` | `WATCH` | [rp-2db76ab0f2 — Content-Addressed Storage and Garbage Collection for Evidence/Artifacts](pointers/rp-2db76ab0f2-content-addressed-storage-and-garbage-collection-for-evidence-artifacts.md) | assurance-audit-metrology | 1 |
| `TRIAGED` | `WATCH` | [rp-d34fd7f580 — Context governance](pointers/rp-d34fd7f580-context-governance.md) | context-memory-project | 1 |
| `NORMALIZED` | `EXPERIMENT` | [rp-49f0f7c524 — context measurement/metrology](pointers/rp-49f0f7c524-context-measurement-metrology.md) | context-memory-project | 1 |
| `NORMALIZED` | `WATCH` | [rp-5cfeb33c92 — Context Reconstruction View](pointers/rp-5cfeb33c92-context-reconstruction-view.md) | research-knowledge-substrate | 1 |
| `NORMALIZED` | `WATCH` | [rp-e274160076 — context validity/freshness model](pointers/rp-e274160076-context-validity-freshness-model.md) | context-memory-project | 1 |
| `TRIAGED` | `WATCH` | [rp-5b1f7413a5 — Contextual confinement for reference/browser agents](pointers/rp-5b1f7413a5-contextual-confinement-for-reference-browser-agents.md) | experience-ux | 1 |
| `NORMALIZED` | `EXPLORE` | [rp-27de64dc8e — Contradiction detection under defeasible evidence](pointers/rp-27de64dc8e-contradiction-detection-under-defeasible-evidence.md) | research-knowledge-substrate | 1 |
| `TRIAGED` | `WATCH` | [rp-96f8b87234 — Control effectiveness](pointers/rp-96f8b87234-control-effectiveness.md) | assurance-audit-metrology | 1 |
| `NORMALIZED` | `WATCH` | [rp-2d5b8a67cf — control retirement experiments](pointers/rp-2d5b8a67cf-control-retirement-experiments.md) | assurance-audit-metrology | 1 |
| `NORMALIZED` | `EXPERIMENT` | [rp-5ebf851583 — counterfactual workflow evaluation](pointers/rp-5ebf851583-counterfactual-workflow-evaluation.md) | workflow-procedural | 1 |
| `NORMALIZED` | `WATCH` | [rp-184849aacb — counterfactual/OPE instrumentation](pointers/rp-184849aacb-counterfactual-ope-instrumentation.md) | routing-reputation-economics | 1 |
...
| `NORMALIZED` | `EXPLORE` | [rp-c6798f9503 — Cryptographic/signed curation attestations](pointers/rp-c6798f9503-cryptographic-signed-curation-attestations.md) | research-knowledge-substrate | 1 |
| `TRIAGED` | `WATCH` | [rp-ad88e49c07 — Cybernetics and control theory for observability/controllability/stability](pointers/rp-ad88e49c07-cybernetics-and-control-theory-for-observability-controllability-stability.md) | cross-disciplinary-bridges | 1 |
| `TRIAGED` | `WATCH` | [rp-f0c0d9085f — Decision rights vs capability vs authority](pointers/rp-f0c0d9085f-decision-rights-vs-capability-vs-authority.md) | governance-constitutional | 1 |
| `NORMALIZED` | `WATCH` | [rp-4089f0d228 — decision-right representation](pointers/rp-4089f0d228-decision-right-representation.md) | assurance-audit-metrology | 1 |
| `NORMALIZED` | `WATCH` | [rp-8d56cf0353 — Demand Accounting & Settlement Science](pointers/rp-8d56cf0353-demand-accounting-settlement-science.md) | reliability-effects-durable-runtime | 1 |
| `TRIAGED` | `WATCH` | [rp-5685518986 — Dual-audience interfaces](pointers/rp-5685518986-dual-audience-interfaces.md) | experience-ux | 1 |
| `NORMALIZED` | `EXPERIMENT` | [rp-96101e4704 — durable backend qualification](pointers/rp-96101e4704-durable-backend-qualification.md) | reliability-effects-durable-runtime | 1 |
| `TRIAGED` | `EXPERIMENT` | [rp-70c444876f — Durable runtime qualification](pointers/rp-70c444876f-durable-runtime-qualification.md) | reliability-effects-durable-runtime, research-knowledge-substrate | 2 |
...
| `NORMALIZED` | `WATCH` | [rp-3bba42bb65 — Evidence Recall and reverse dependency propagation](pointers/rp-3bba42bb65-evidence-recall-and-reverse-dependency-propagation.md) | assurance-audit-metrology | 1 |
| `TRIAGED` | `INVESTIGATE` | [rp-4d0c0a14c0 — Evidence reuse and invalidation](pointers/rp-4d0c0a14c0-evidence-reuse-and-invalidation.md) | assurance-audit-metrology | 2 |
...
| `NORMALIZED` | `WATCH` | [rp-eff5f8dd83 — Federated Experience Semantics](pointers/rp-eff5f8dd83-federated-experience-semantics.md) | research-knowledge-substrate | 1 |
...
| `NORMALIZED` | `WATCH` | [rp-09aff1b260 — Finality and Reopening Semantics](pointers/rp-09aff1b260-finality-and-reopening-semantics.md) | research-knowledge-substrate | 1 |
...
| `TRIAGED` | `WATCH` | [rp-ccad7bea11 — Formal workflow semantics federation](pointers/rp-ccad7bea11-formal-workflow-semantics-federation.md) | workflow-procedural | 1 |
| `TRIAGED` | `WATCH` | [rp-0a4bd91301 — Governance debt](pointers/rp-0a4bd91301-governance-debt.md) | governance-constitutional | 1 |
| `NORMALIZED` | `EXPERIMENT` | [rp-e0994063b4 — governance debt metrology](pointers/rp-e0994063b4-governance-debt-metrology.md) | assurance-audit-metrology | 1 |
| `TRIAGED` | `WATCH` | [rp-a90d841a43 — Harness-dependent agentic benchmarking](pointers/rp-a90d841a43-harness-dependent-agentic-benchmarking.md) | local-models-evaluation | 1 |
| `TRIAGED` | `WATCH` | [rp-a9eaccec1a — High Reliability Organizations and resilience engineering for near misses, recovery and operating posture](pointers/rp-a9eaccec1a-high-reliability-organizations-and-resilience-engineering-for-near-misses-recove.md) | cross-disciplinary-bridges | 1 |
...
| `NORMALIZED` | `WATCH` | [rp-9831fbfe3b — Independent Semantic Verification of Agent Work](pointers/rp-9831fbfe3b-independent-semantic-verification-of-agent-work.md) | research-knowledge-substrate | 1 |
...
| `NORMALIZED` | `WATCH` | [rp-101da5dce0 — Learning Invalidation Graph](pointers/rp-101da5dce0-learning-invalidation-graph.md) | research-knowledge-substrate | 1 |
...
| `NORMALIZED` | `EXPERIMENT` | [rp-af02efd7bd — Observability Projection Qualification Pack](pointers/rp-af02efd7bd-observability-projection-qualification-pack.md) | research-knowledge-substrate | 1 |
...
| `TRIAGED` | `WATCH` | [rp-b019955343 — Partial observability and active sensing](pointers/rp-b019955343-partial-observability-and-active-sensing.md) | reliability-effects-durable-runtime | 1 |
| `NORMALIZED` | `WATCH` | [rp-130e5f7ebf — poisoning-resistant memory curation](pointers/rp-130e5f7ebf-poisoning-resistant-memory-curation.md) | context-memory-project | 1 |
| `TRIAGED` | `WATCH` | [rp-5ecdf2f016 — Policy / waiver / deprecation lifecycle](pointers/rp-5ecdf2f016-policy-waiver-deprecation-lifecycle.md) | governance-constitutional | 1 |
| `TRIAGED` | `INVESTIGATE` | [rp-7b6d5e803a — Portable capability components](pointers/rp-7b6d5e803a-portable-capability-components.md) | runtime-interop-identity | 2 |
...
| `TRIAGED` | `INVESTIGATE` | [rp-7185579909 — Procedural memory and workflow evolution](pointers/rp-7185579909-procedural-memory-and-workflow-evolution.md) | workflow-procedural | 3 |
...
| `NORMALIZED` | `WATCH` | [rp-e47985b949 — Reconstructive Closure](pointers/rp-e47985b949-reconstructive-closure.md) | research-knowledge-substrate | 1 |
| `NORMALIZED` | `WATCH` | [rp-4f1038f0b0 — Repository Boundary & Information Survival](pointers/rp-4f1038f0b0-repository-boundary-information-survival.md) | research-knowledge-substrate | 1 |
| `NORMALIZED` | `WATCH` | [rp-8e70588c74 — Requirement Clarification as Governed Intake](pointers/rp-8e70588c74-requirement-clarification-as-governed-intake.md) | research-knowledge-substrate | 1 |
...
| `TRIAGED` | `WATCH` | [rp-cc1a52b33e — retraction/correction watchers with downstream impact propagation](pointers/rp-cc1a52b33e-retraction-correction-watchers-with-downstream-impact-propagation.md) | research-knowledge-substrate | 1 |
| `TRIAGED` | `INVESTIGATE` | [rp-3f41287ed1 — Risk aggregation](pointers/rp-3f41287ed1-risk-aggregation.md) | assurance-audit-metrology, governance-constitutional | 2 |
| `TRIAGED` | `EXPERIMENT` | [rp-6b2eec5e7c — RO-Crate/JSON-LD export qualification](pointers/rp-6b2eec5e7c-ro-crate-json-ld-export-qualification.md) | research-knowledge-substrate | 1 |
...
| `NORMALIZED` | `WATCH` | [rp-fed4dc2f44 — Semantic Compaction with Preserved Golden Queries](pointers/rp-fed4dc2f44-semantic-compaction-with-preserved-golden-queries.md) | research-knowledge-substrate | 1 |
...
| `TRIAGED` | `INVESTIGATE` | [rp-660ba70aac — Semantic visual regression](pointers/rp-660ba70aac-semantic-visual-regression.md) | experience-ux | 2 |
| `NORMALIZED` | `WATCH` | [rp-ee9e40a114 — semantic-fidelity measurement](pointers/rp-ee9e40a114-semantic-fidelity-measurement.md) | runtime-interop-identity | 1 |
| `TRIAGED` | `WATCH` | [rp-a532ee0e38 — source identity resolution and version-family reconciliation](pointers/rp-a532ee0e38-source-identity-resolution-and-version-family-reconciliation.md) | research-knowledge-substrate | 1 |
| `NORMALIZED` | `WATCH` | [rp-1db5eb23ea — systemic resource-risk aggregation](pointers/rp-1db5eb23ea-systemic-resource-risk-aggregation.md) | routing-reputation-economics | 1 |
...
| `NORMALIZED` | `WATCH` | [rp-7f92fc1553 — Task Revision & Scope Change Semantics](pointers/rp-7f92fc1553-task-revision-scope-change-semantics.md) | research-knowledge-substrate | 1 |
...
| `NORMALIZED` | `WATCH` | [rp-0332a66e09 — Windows-native ephemeral verification](pointers/rp-0332a66e09-windows-native-ephemeral-verification.md) | research-knowledge-substrate | 1 |
